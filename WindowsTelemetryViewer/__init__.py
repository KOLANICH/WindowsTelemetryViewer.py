import sys
from PyQt5.QtCore import QObject, QAbstractTableModel, Qt, QVariant, QSize, QEvent
from PyQt5.QtWidgets import QApplication, QWidget, QTableView, QGridLayout, QDoubleSpinBox, QTableWidget, QPushButton, QTableWidgetItem, QCheckBox, QFileDialog, QMessageBox, QBoxLayout, QSizePolicy, QLabel, QProgressBar, QScrollArea, QTextEdit, QDockWidget, QMainWindow, QErrorMessage
from PyQt5.QtGui import QWindow, QIcon
from PyQt5.Qt import QHeaderView

from .IRBS import SelectedRBS
from .TableWidget import TableWidget
from .PyQtJsonModel import *
...
class TelemetryViewerGUI(QMainWindow):
	def __init__(self):
		...
		try:
			self.fileDlg.setDirectory(str(Path(os.environ['ProgramData']) / "Microsoft" / "Diagnosis"))
		except:
			self.fileDlg.setDirectory(".")
